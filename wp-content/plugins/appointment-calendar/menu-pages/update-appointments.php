	...
	<form action="" method="post" name="manageservice">
		<table width="100%" class="table" >
		   <tr>
			...
			class="inputheight"/>&nbsp;<a href="#" rel="tooltip" title="Client Name." ><i class="icon-question-sign"></i></a>
			</td>
		  </tr>
		  <tr>
			...
			class="inputheight"/>&nbsp;<a href="#" rel="tooltip" title="Client Email." ><i class="icon-question-sign"></i></a>
			</td>
		  </tr>
		   <tr>
			...
			<td><select id="serviceid" name="serviceid">
				  <?php //get all service list	
					...
					<?php } ?>
		  </select>&nbsp;<a href="#" rel="tooltip" title="Service Name." ><i class="icon-question-sign"></i></a>			  
		  </tr>
		  <tr>
			<th scope="row"><strong>Phone</strong></th>
			<td><strong>:</strong></td>
			<td><input name="appphone" type="text" id="appphone"  value="<?php echo $appointmentdetails->phone; ?>" class="inputheight"/ maxlength="12">&nbsp;<a href="#" rel="tooltip" title="Client Phone Number." ><i class="icon-question-sign"></i></a>
			</td>
		  </tr>
		 <tr>
			<th scope="row"><strong>Star Time</strong></th>
			<td><strong>:</strong></td>
			<td><input name="start_time" type="text" id="start_time"  value="<?php echo $appointmentdetails->start_time; ?>" class="inputheight"/>&nbsp;<a href="#" rel="tooltip" title="Appointment Start Time." ><i class="icon-question-sign"></i></a>
			</td>
		  </tr>
		  <tr>
			<th scope="row"><strong>End Time</strong></th>
			<td><strong>:</strong></td>
			<td><input name="end_time" type="text" id="end_time"  value="<?php echo $appointmentdetails->end_time; ?>" class="inputheight"/>&nbsp;<a href="#" rel="tooltip" title="Appointment End Time." ><i class="icon-question-sign"></i></a>
			</td>
		  </tr>
		  <tr>
			<th scope="row"><strong>Date</strong></th>
			<td><strong>:</strong></td>
			<td><input name="start_date" type="text" id="start_date" value="<?php echo $appointmentdetails->date; ?>" class="inputheight"/>&nbsp;<a href="#" rel="tooltip" title="Appointment Date." ><i class="icon-question-sign"></i></a>
			</td>
		  </tr>
		  <tr>
			<th scope="row"><strong>Description</strong></th>
			<td><strong>:</strong></td>
			<td><textarea name="app_desc" id="app_desc"><?php echo $appointmentdetails->note; ?></textarea>&nbsp;<a href="#" rel="tooltip" title="Appointment Description." ><i class="icon-question-sign"></i></a>
			</td>
		  </tr>
		   <tr>
			...
			</select>&nbsp;<a href="#" rel="tooltip" title="Appointment Status" ><i class="icon-question-sign"></i></a>
			</td>
		  </tr>
		  <tr>
			...
			</select>&nbsp;<a href="#" rel="tooltip" title="Appointment Booked By." ><i class="icon-question-sign"></i></a>
			</td>
		  </tr>
	...
	<!--/******************************** update appointment form **********************************/-->
				<table width="100%" class="table" >
				  ...
				  <tr>
					...
					<td><strong>:</strong></td>
					<td><em><?php echo date("h:ia", strtotime($appdetails->start_time)); ?></em></td>
				  </tr>
				  <tr>
					<th scope="row">End Time</th>
					<td><strong>:</strong></td>
					<td><em><?php echo date("h:ia", strtotime($appdetails->end_time)); ?></em></td>
				  </tr>
				  <tr>
