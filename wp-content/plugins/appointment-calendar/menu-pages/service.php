				...
				<th id="yw7_c1" colspan="3"><!--- header rename and delete button right box-->
					<div align="right">
						<?php if($gruopname->id !='1') { ?>
							<a rel="tooltip" href="#" id="<?php echo $gruopname->id; ?>" onclick="editgruop(<?php echo $gruopname->id; ?>)" title="Rename Category">Rename</a>	 | 
							<a rel="tooltip" href="?page=service&gid=<?php echo $gruopname->id; ?>" onclick="return confirm('Do you want to delete this catagory')" title="Delete">Delete</a>
						<?php } ?>
				</div>					</th></tr>
				<tr>
				<!--<th id="yw7_c0">#</th>-->
...
<a rel="tooltip" href="?page=manage-service&sid=<?php echo $service->id; ?>" title="Update"><i class="icon-pencil"></i></a> &nbsp;
<a rel="tooltip" href="?page=service&sid=<?php echo $service->id; ?>" onclick="return confirm('Do you want to delete this service')" title="Delete" ><i class="icon-remove"></i>							</td>
					</tr>
					<?php } ?>
					<tr><td colspan="6">
