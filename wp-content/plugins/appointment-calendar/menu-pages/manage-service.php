...
<form action="" method="post" name="manageservice">
	<table width="100%" class="table" >
	   <tr>
		<th width="18%" scope="row">Name</th>
		<td width="5%">&nbsp;</td>
		<td width="77%"><input name="name" type="text" id="name"  value="<?php echo $servicedetails1->name; ?>" class="inputheight"/>&nbsp;<a href="#" rel="tooltip" title="Service Name" ><i class="icon-question-sign"></i></a></td>
	  </tr>
	  <tr>
	   ...
	   <tr>
		...
		<td>&nbsp;</td>
		<td><input name="Duration" type="text" id="Duration"  value="<?php echo $servicedetails1->duration; ?>" class="inputheight"/>&nbsp;<a href="#" rel="tooltip" title="Service Duration, Enter Numeric Value, eg: 5, 10, 15, 30, 60" ><i class="icon-question-sign"></i> </a></td>
	  </tr>
	  ...
	  <tr>
		...
		<td>&nbsp;</td>
		<td><input name="cost" type="text" id="cost" value="<?php echo $servicedetails1->cost; ?>" class="inputheight"/>&nbsp;<a href="#" rel="tooltip" title="Service Cost, Enter Numeric Value eg: 5 , 10, 25, 50, 100, 150" ><i class="icon-question-sign"></i></a>
		</td>
	  </tr>
	  <tr>
