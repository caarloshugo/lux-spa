...
<form name="emailsettings" action="?page=notificationsettings"  method="post">
  ...
  <tr>
    ...
    <td width="69%"><input name="enable" type="checkbox" id="enable" <?php if(get_option('emailstatus') == 'on') echo 'checked'; ?> />&nbsp;<a href="#" rel="tooltip" title="ON/OFF Notification" ><i class="icon-question-sign"></i> </a>
	</td>
    <td width="3%">&nbsp;</td>
    <td width="3%">&nbsp;</td>
    <td width="3%">&nbsp;</td>
...
<!--smtp-->
  ...
  <tr id="smtpdetails2" style="display:none;">
    ...
    <td><strong>:</strong></td>
    <td><input name="hostname" type="text" id="hostname" class="inputhieght" value="<?php echo $emaildetails['hostname']; ?>" />&nbsp;<a href="#" rel="tooltip" title="Host Name <br>Like Eg: <br>Gmail = smtp.gmail.com, <br>Yahoo = smtp.yahoo.com" ><i class="icon-question-sign"></i></a>
	</td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
  ...
  <tr id="smtpdetails3" style="display:none;">
    ...
    <td><strong>:</strong></td>
    <td><input name="portno" type="text" id="portno" value="<?php echo $emaildetails['portno']; ?>" />&nbsp;<a href="#" rel="tooltip" title="Smtp Post Number <br>Gmail & Yahoo Port Number = 465" ><i class="icon-question-sign"></i></a>
	</td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
