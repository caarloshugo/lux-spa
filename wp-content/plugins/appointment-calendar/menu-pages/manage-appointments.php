...
<table width="100%" border="0" class="table">
  <tr>
	...
	</div>&nbsp;<button id="filter" class="btn btn-small btn-danger" type="submit" name="filter">Filter Appointments</button>&nbsp;<a href="#" rel="tooltip" title="Filter Appointments"><i class="icon-question-sign"></i> </a>
  </tr>
  </table>
  </form>
  <?php 
 ...
 <form action="" method="post" name="manage-appointments"> 
  ...
  <tr>
    ...
    <th scope="col"><a href="#" rel="tooltip" title="Select All Appointments" ><input type="checkbox" id="checkbox" name="checkbox[]" value="0" /></a>
...
if($all_appointments)
{
  ...
  <tr>
    ...
    <td><em><?php echo date("F dS  Y", strtotime($appointment['date'])); ?></em></td>
    <td><em><?php echo date("h:ia", strtotime($appointment['start_time']))." To ".date("h:ia", strtotime($appointment['end_time'])); ?></em></td>
    <td><em>
    ...
    <td>
		<a href="?page=update-appointment&viewid=<?php echo $appointment['id']; ?>" title="View" rel="tooltip"><i class="icon-eye-open"></i></a>
		 &nbsp;
		<a href="?page=update-appointment&updateid=<?php echo $appointment['id']; ?>" title="Update" rel="tooltip"><i class="icon-pencil"></i></a>&nbsp;
		<a href="?page=manage-appointments&delete=<?php echo $appointment->id; ?>" rel="tooltip" title="Delete" 
  ...
  <?php } else { ?>
  <tr ><td colspan="8" class="alert"><strong>Sorry No Appointments</strong></td>
  </tr>
   <tr>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
...
// delete all selected appointment with ckeckbox
