...
$staffOrder = $this['config']->get('staffOrder'); 
...
<div id="system" class="staffProfile">
...
<div class="home-service">
    ...
    <?php $paged = (get_query_var('paged')) ? get_query_var('paged') : 1;
         query_posts("post_type=staff-profile&showposts=50&orderby=" .$orderby. "&order=" .$order. "&paged= $paged"); ?>

    <?php $k=1;while(have_posts()) : the_post(); ?>
    
    <div class="nspArt nspCol5" style="padding:0 10px 0px 10px;">
          <div class="nspArtWrapper">
            <h4 class="nspHeader tcenter fnone"><a href="<?php the_permalink() ?>" title="<?php echo get_the_title($ID); ?>"><?php echo get_the_title($ID); ?></a></h4>
