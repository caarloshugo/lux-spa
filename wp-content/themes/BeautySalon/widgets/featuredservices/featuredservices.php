...
class Warp_FeaturedServices extends WP_Widget {

	function Warp_FeaturedServices() {
		$widget_ops = array('description' => 'Display default Wordpress Featured Services');
		parent::WP_Widget(false, 'Warp - Featured Services', $widget_ops);      
	}
	...
	function widget($args, $instance) {  
		...
		<div class="home-service">
         ...
         <?php 
          if(have_posts()) :
          $my_query = new WP_Query('post_type=service&orderby='.$sortingType.'&showposts=' .$postNumber. '&paged= $paged');
		...
		$output = $warp['template']->get('featuredservices.output', "");
	...
	/*function update($new_instance, $old_instance) {                
		...
		$instance['sortingType'] = $new_instance['sortingType'];	
		return $instance;
	}*/
...
register_widget('Warp_FeaturedServices');