...
//////////////////////////////////////////////////////////////////////////
	$.fn.imgShadow = function (options) {
        ...
        $(this).each(function() {
            ...
            $('<div class="under-shadow"><img src="<?php echo $template_path; ?>/timthumb.php?src=<?php echo $template_path; ?>/images/shadows/shadow'+ options.shadow +'.png&amp;w='+$(this).width()+'" alt="" /></div>').insertAfter(this);
        });
    };
