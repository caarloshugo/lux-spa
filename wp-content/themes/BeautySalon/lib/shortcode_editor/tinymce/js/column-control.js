function ScnColumnMaker(h, i, f) {
  ...
  this.buildTextControl = function () {
    ...
    var b = jQuery("<input>").attr("type", "button").attr("style", "width: 40px;position:absolute;right: 0px;bottom: 4px;font-size: 22px; border:none;background:none;").attr("value", "\u232b");
    a.append(b);
    b.click(function () {
